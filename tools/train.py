...
def train(hyp, opt, device):
    ...
    if pretrained:
        ...
        from nets import YOLOv3Tiny, YOLOv3SPP
    ...
    LOGGER.info(f'Image sizes {image_size} train, {image_size} val\n'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='./weights/weights/last.pt', help='initial weights path')
    ...
    parser.add_argument('--image-size', '--img', '--img-size', type=int, default=640,
